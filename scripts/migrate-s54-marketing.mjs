...
async function runMigration() {
  try {
    ...
    await sql`CREATE INDEX IF NOT EXISTS idx_affiliate_links_store_id ON affiliate_links(store_id)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_affiliate_links_code ON affiliate_links(code)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_affiliate_tracking_link_id ON affiliate_tracking(link_id)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_social_shares_store_id ON social_shares(store_id)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_social_shares_platform ON social_shares(platform)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_email_templates_store_id ON email_templates(store_id)`;
    await sql`CREATE INDEX IF NOT EXISTS idx_email_subscribers_store_id ON email_subscribers(store_id)`;
