-- Marketing tools tables for Sprint S54

-- Affiliate links table (extends referral system)
...
CREATE INDEX IF NOT EXISTS idx_affiliate_tracking_link_id ON affiliate_tracking(link_id);
CREATE INDEX IF NOT EXISTS idx_social_shares_store_id ON social_shares(store_id);
...
CREATE INDEX IF NOT EXISTS idx_email_subscribers_store_id ON email_subscribers(store_id);
