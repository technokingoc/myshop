export type OrderStatus = "placed" | "confirmed" | "preparing" | "shipped" | "in-transit" | "delivered" | "cancelled";
...
export const STATUS_FLOW: OrderStatus[] = ["placed", "confirmed", "preparing", "shipped", "in-transit", "delivered"];
export const ALL_STATUSES: OrderStatus[] = ["placed", "confirmed", "preparing", "shipped", "in-transit", "delivered", "cancelled"];
...
export const statusColorMap: Record<string, { bg: string; text: string; border: string; badge: string }> = {
  ...
  preparing:  { bg: "bg-blue-50",    text: "text-blue-700",    border: "border-blue-500",   badge: "bg-blue-100 text-blue-700" },
  ...
  "in-transit": { bg: "bg-indigo-50", text: "text-indigo-700", border: "border-indigo-500", badge: "bg-indigo-100 text-indigo-700" },
