...
const dict = {
  en: {
    ...
    confirmDeliveryDesc: "Did you receive your order successfully?",
    yesReceived: "Yes, I received it",
    notReceived: "Not yet received",
    deliveryDetails: "Delivery Details",
    deliveryDetailsDesc: "Help us improve by sharing details about your delivery (optional)",
    deliveryPhotos: "Delivery Photos",
    optional: "Optional",
    photosDesc: "Upload photos of your delivered package (max 5 photos, 5MB each)",
    deliveryRating: "Delivery Experience",
    sellerRating: "Seller Rating",
    deliveredBy: "Delivered by",
    deliveryLocation: "Delivery location",
    additionalNotes: "Additional notes",
    deliveredByPlaceholder: "Courier name or company",
    deliveryLocationPlaceholder: "e.g., Left at door, Handed to me",
    notesPlaceholder: "Any additional feedback about the delivery...",
    ...
    confirmationSubmitted: "Delivery confirmation submitted",
    confirmationFailed: "Failed to submit confirmation",
    submittingConfirmation: "Submitting confirmation...",
    thankYouForConfirming: "Thank you for confirming your delivery. Your feedback helps us improve our service.",
    statusLabels: {
      placed: "Order Placed",
  ...
  pt: {
    ...
    trackingInfo: "Informação de Rastreio",
    ...
    confirmDeliveryDesc: "Recebeu a sua encomenda com sucesso?",
    yesReceived: "Sim, recebi",
    notReceived: "Ainda não recebi",
    deliveryDetails: "Detalhes da Entrega",
    deliveryDetailsDesc: "Ajude-nos a melhorar partilhando detalhes sobre a sua entrega (opcional)",
    deliveryPhotos: "Fotos da Entrega",
    optional: "Opcional",
    photosDesc: "Envie fotos da sua encomenda entregue (máx 5 fotos, 5MB cada)",
    deliveryRating: "Experiência de Entrega",
    ...
    deliveredByPlaceholder: "Nome do estafeta ou empresa",
    deliveryLocationPlaceholder: "ex: Deixado na porta, Entregue em mão",
    notesPlaceholder: "Qualquer comentário adicional sobre a entrega...",
    skipDetails: "Saltar detalhes",
    clickToUpload: "Clique para enviar fotos",
    uploading: "A enviar...",
    fileTooLarge: "Ficheiro muito grande (máx 5MB)",
    invalidFileType: "Apenas ficheiros de imagem são permitidos",
    uploadFailed: "Falha ao enviar foto",
    confirmationSubmitted: "Confirmação de entrega enviada",
    confirmationFailed: "Falha ao enviar confirmação",
    submittingConfirmation: "A enviar confirmação...",
    thankYouForConfirming: "Obrigado por confirmar a sua entrega. O seu feedback ajuda-nos a melhorar o serviço.",
    statusLabels: {
      placed: "Pedido Feito",
