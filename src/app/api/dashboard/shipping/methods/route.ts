  ...
  try {
    ...
    const [newMethod] = await db
      ...
      .values({
        ...
        name: name.trim(),
        type: type,
        rate: rate ? parseFloat(rate).toString() : '0',
        freeShippingMinOrder: freeShippingMinOrder ? parseFloat(freeShippingMinOrder).toString() : '0',
        estimatedDays: estimatedDays ? parseInt(estimatedDays) : 3,
        maxWeight: maxWeight ? parseFloat(maxWeight).toString() : '0',
