...
- [ ] **S36: Product Management Premium** — Drag-and-drop image reordering. Image zoom on hover. Variant management (size/color/material). Stock tracking with low-stock alerts. Bulk product actions (activate/deactivate/delete). Product duplication.
